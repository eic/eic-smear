...
public:
   ...
   static int CalculateId(const erhic::VirtualParticle* particle) {
      ...
      // Skip pid of 0 (the default) as this is a dummy "ROOTino".
      if(pdg and particle->Id() not_eq 0) {
         id = particle->Id();
      } // if
   ...
   /*
    ...
    If mass is greater than zero, use this as the assumed mass when calculating via momentum, otherwise calculate
