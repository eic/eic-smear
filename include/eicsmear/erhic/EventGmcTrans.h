/**
 \brief gmc_trans transversely polarised DIS event
 \file EventGmcTrans.h
 Declaration of class EventGmcTrans
 \author Thomas Burton
 \date 9/20/12
 \copyright 2012 BNL.
 */

#ifndef _EICSMEAR_EVENTGMCTRANS_
#define _EICSMEAR_EVENTGMCTRANS_
...
//      void SetPhiSpin( const Double_t& );
//      void SetPhiHadron( const Double_t& );
      /**
...
//      void SetHadronZ( const Double_t z ) { mZ = z; }
//      void SetHadronPt( const Double_t pt ) { mHadronPt = pt; }
//      Double_t GetLeptonTheta() const { return mLeptonTheta; }
//      Double_t GetLeptonPhi() const { return mLeptonPhi; } // [0,2i)
...
//      Double_t GetXF1() const { return x() * f1(); }
//      Double_t GetXG1() const { return x() * g1(); }
//      Double_t GetXH1() const { return x() * h1(); }
...
//      void Clear(Option_t* = "") { }
   ...
   protected:
      ...
      Double32_t mQSquared; // Negative squared four-momentum of the exchanged boson
      Double32_t mBjorkenX; // Longitudinal momentum fraction in the infinite momentum frame
